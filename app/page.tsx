      ...
      <div className="container">
        ...
        <div className="grid">
          ...
          <div className="card">
            ...
            <div style={{ fontSize: '12px', color: '#666', marginTop: '6px' }}>
              Chiamata: Geocodifica (server) – parametri minimi: address="{address?.trim() || '—'}"
            </div>
          ...
          <div className="card">
            ...
            <div className="grid-2">
              <div>
                ...
                <input className="input" inputMode="decimal" value={lat} onChange={(e) => setLat(e.target.value)} placeholder="41.9028" />
              </div>
              <div>
                <label className="label">Longitudine (−180..180)</label>
                <input className="input" inputMode="decimal" value={lng} onChange={(e) => setLng(e.target.value)} placeholder="12.4964" />
              </div>
            </div>
        ...
        <div className="grid-results">
          <div className="card">
            ...
            <p className="hint">Valore calcolato come occupancy × 100.</p>
          </div>
          <div className="card">
            <h3 className="section-title">ADR</h3>
            <p className="kpi">{fmtCurrency(result?.average_daily_rate)}</p>
            <p className="hint">Prezzo medio giornaliero secondo AIRROI.</p>
          </div>
          <div className="card">
